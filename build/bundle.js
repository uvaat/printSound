...
},{"es6-promise":4}],2:[function(require,module,exports){
'use strict';
...
window.addEventListener('load', function () {
  ...
  sound.loadSound("https://ia801404.us.archive.org/16/items/FREE_background_music_dhalius/BloodCity.mp3").then(function () {

    sound.playSound();
    _paper2.default.setup('myCanvas');

    var path = new _paper2.default.Path({
      segments: new _paper2.default.Point(0, 0),
      strokeColor: '#2c3e50'
    });
...
},{"./Sound":1,"paper":5}],3:[function(require,module,exports){
...
},{"./node/extend":3,"./node/window":3}],6:[function(require,module,exports){
